...
<div class="sidebar">
  ...
  <a class="nav-item" href="/forex/grafik"><span class="nav-dot"></span>LIV_XAUUSDT_BINANCE</a>
...
<div class="main">
  <div class="head">
    <div>
      ...
      <div class="page-sub">LIV_XAUUSDT_BINANCE · $500 kasa · $50×50x · taker %0.05</div>
    </div>
  </div>
  <div class="hero">
    <div class="glass">
      <h2>Sayfa açık</h2>
      <p>LIV_XAUUSDT_BINANCE sanal Isolated: kasa $500, $50 × 50x, Binance taker. Emir borsaya gitmez. Liste <a href="/forex/islemler" style="color:var(--gold)">İşlemler</a>’de.</p>
      <div class="sys">
        <a href="/poly">← Poly</a>
...
<div class="sidebar">
  ...
  <a class="nav-item __FX_NAV_G1__" href="/forex/grafik"><span class="nav-dot"></span>LIV_XAUUSDT_BINANCE</a>
...
function paper(side){
  ...
  const msg=FX_ALGO==='a2'
    ...
    : FX_ALGO==='gps'
    ? 'Sanal Isolated MARKET '+ (side==='buy'?'BUY':'SELL') +' GPSUSDT @ '+px+' — Kalman+VWAP $100×10x'
    : FX_ALGO==='gps2'
...
async function loadChart(){
  ...
  document.getElementById('hud').innerHTML=(FX_ALGO==='bybit'
    ...
    : FX_ALGO==='gps'
    ? FX_PAIR+', '+lab+' <span>GPSUSDT · Isolated $100×10x · Kalman+VWAP · taker %0.05</span>'
    : FX_ALGO==='gps2'
...
function renderBook(b){
  ...
  if(sub && (b.book==='gps' || b.book==='gps2' || FX_GPS) && b.costs){
    const live=b.live||{};
    const virt=FX_ALGO==='gps' && !!(b.virtual || live.virtual || live.paper);
    const on=FX_ALGO==='gps' && !virt && live.enabled && !live.paused;
    ...
    const tag=FX_ALGO==='gps2'||virt?'sanal Isolated $':(on?'CANLI Isolated $':'Isolated $');
    const mot=FX_ALGO==='gps'?' · Kalman+VWAP':'';
    ...
    if(titleSmall) titleSmall.textContent=FX_ALGO==='gps2'
      ...
      : (virt
      ? 'Binance Isolated sanal · $'+mg+' × '+lv+'x · Kalman+VWAP · taker %0.05'
      : (on
    ...
    if(FX_ALGO==='gps'){
      ...
      if(hud){
        const lab=(TFS.find(x=>x[0]===_tf)||[_tf,_tf])[1];
        hud.innerHTML=FX_PAIR+', '+lab+' <span>GPSUSDT · Isolated $100×10x · Kalman+VWAP · taker %0.05</span>';
      }
    }
  }
...
def _chart_page(algo: str) -> str:
    ...
    if algo == "bybit":
        ...
        pair, sub, book, foot = "GPSUSDT", "Binance Isolated sanal · $100 × 10x · Kalman+VWAP · taker %0.05", "GPSUSDT · Isolated $100 × 10x · Kalman+VWAP · taker %0.05 · emir yok", "GPSUSDT"
        body = "fx-gps"
    elif algo == "gps2":
...
<div class="sidebar">
  ...
  <a class="nav-item" href="/forex/yapay-zeka-analiz"><span class="nav-dot"></span>Yapay Zeka Analiz</a>
  <div class="sidebar-footer">LIV_XAUUSDT_BINANCE · $50×50x</div>
</div>
<div class="desk">
  <div class="head">
    <h1>Geçmiş</h1>
    <small>LIV_XAUUSDT_BINANCE · Isolated $50 × 50x · taker %0.05</small>
  </div>
  <div class="tabs">
...
FOREX_GATE_ISLEMLER_HTML = (
    ...
    .replace("/poly/api/forex/book", "/poly/api/forex/gate/book")
    .replace("LIV_XAUUSDT_BINANCE · $50×50x", "XAUUSDT · Gate $100×30x · min $9")
    .replace("LIV_XAUUSDT_BINANCE · Isolated $50 × 50x · taker %0.05", "XAUUSDT · Gate $100×30x · min kâr $9")
)
...
FOREX_B103_ISLEMLER_HTML = (
    ...
    .replace("LIV_XAUUSDT_BINANCE · $50×50x", "XAUUSD · B1#03 MUM · $100×500x")
    .replace("LIV_XAUUSDT_BINANCE · Isolated $50 × 50x · taker %0.05", "XAUUSD · B1#03 MUM · sanal $100 × 500x")
)
...
<div class="desk">
  <div class="head">
    <h1>İşlemler</h1>
    <small id="gps-sub">GPSUSDT · Isolated $100 × 10x · Kalman+VWAP</small>
  </div>
  <div class="box">
  ...
  <div class="foot" id="gps-foot">GPSUSDT Isolated · sanal $100 × 10x · Kalman+VWAP · taker %0.05</div>
</div>
<script>
function money(n){ return n==null?'—':Number(n).toFixed(2); }
...
function render(b){
  const live=b.live||{};
  const virt=!!(b.virtual || live.virtual || live.paper);
  const on=!virt && live.enabled && !live.paused;
